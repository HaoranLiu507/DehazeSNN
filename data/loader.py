...
class PairLoader(Dataset):
    def __init__(self, data_dir, sub_dir, mode, size=256, edge_decay=0, only_h_flip=False):
        ...
        #
        #     if self.mode == 'train':
        #         [source_img, target_img] = augment([source_img, target_img], self.size, self.edge_decay,
        #                                            self.only_h_flip)
        #
        #     if self.mode == 'valid':
        ...
        #         {'source': hwc_to_chw(source_img), 'target': hwc_to_chw(target_img), 'filename': img_name})
